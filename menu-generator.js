...
async function generateMainMenuImage() {
    ...
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(70, 70)">
            ...
            <text x="0" y="165" font-family="sans-serif" font-size="16" fill="white" opacity="0.8">EARLY ACCESS VERSION 2.0 // GEMMA 4</text>
        </g>
        ...
        <g transform="translate(830, 70)">
            ...
            <g transform="translate(15, 230)" font-family="sans-serif" fill="white">
                <text font-weight="bold" font-size="18">L'Éveil de Gemma 4</text>
                ...
                <text y="110" font-size="14" opacity="0.9">• IA Gemma 4 ultra-réactive</text>
