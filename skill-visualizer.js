...
async function generateSkillTable(skills) {
    ...
    skills.forEach((skill, i) => {
        ...
        <g transform="translate(${padding}, ${y})">
            ...
            <!-- Skill Name -->
            <text x="30" y="40" font-family="sans-serif" font-weight="bold" font-size="28" fill="white">${skill.name.toUpperCase()}</text>

            <!-- Skill Type -->
            <rect x="30" y="55" width="100" height="25" rx="5" fill="${color}" opacity="0.3" />
            <text x="80" y="73" text-anchor="middle" font-family="sans-serif" font-weight="bold" font-size="16" fill="${color}">${skill.type}</text>

            <!-- Mana Cost -->
            <text x="150" y="73" font-family="sans-serif" font-size="18" fill="#4d8bff">💧 ${skill.manaCost} PM</text>
